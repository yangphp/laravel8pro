...
<head>
    ...
    <link rel="stylesheet" href="{{asset('/admin/lib/layui-v2.5.5/css/layui.css')}}" media="all">
    <!--[if lt IE 9]>
            ...
            <form class="layui-form" action="">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="captcha-img">
                        <img id="captchaPic" src="{{captcha_src()}}" onclick="this.src='/captcha?'+Math.random()">
                    </div>
                </div>
                <!-- <div class="layui-form-item">
...
<script src="{{asset('/admin/lib/jq-module/jquery.particleground.min.js')}}" charset="utf-8"></script>
<script>
